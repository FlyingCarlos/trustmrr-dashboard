...
- **Tracked segments**: potential pool ($200–$15k monthly revenue, fastest growing, all categories), focus categories (mobile-apps / games / health-fitness / productivity / utilities, $100–$20k), recent listings, small deals (asking ≤ $50k). Items are keyword-flagged `ios` / `chrome` / `habit`.
